...
func TestAccApiToken_PolicyOrderDoesntMatter(t *testing.T) {
	rnd := utils.GenerateRandomResourceName()
	name := "cloudflare_api_token.policy-order-test"
	accountID := os.Getenv("CLOUDFLARE_ACCOUNT_ID")

	zoneReadPermissionGroupId := "4755a26eedb94da69e1066d98aa820be"
	zoneWritePermissionGroupId := "e6d2666161e84845a636613608cee8d5"

	build := func(permissionId1, permissionId2 string) string {
		return acctest.LoadTestCase("api_token-policy-order.tf", rnd, accountID, permissionId1, permissionId2)
	}
